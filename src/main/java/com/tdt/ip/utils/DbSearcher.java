...
public class DbSearcher {
     ...
     * @throws IOException
     */
    public IpVo memorySearch(long ip) throws IOException {
...
//        int city_id = (int) Util.getIntLong(dbBinStr, dataPtr);
        ...
        return region2IpVo(region);
    }

    private IpVo region2IpVo(String region) {
        if (StringUtils.isNotBlank(region)) {
            ...
            if (split.length > 0) {
                ...
                String city = split[3];
                String network = split[4];
                return IpVo.builder().country(country).province(province).city(city).network(network).build();
            }
        }
        return null;
    }
     ...
     * @throws IOException
     */
    public IpVo memorySearch(String ip) throws IOException {
     ...
     * @throws IOException
     */
    public IpVo getByIndexPtr(long ptr) throws IOException {
        raf.seek(ptr);
...
//        int city_id = (int) Util.getIntLong(data, 0);
     ...
     * @throws IOException
     */
    public IpVo btreeSearch(long ip) throws IOException {
...
//        int city_id = (int) Util.getIntLong(data, 0);
     ...
     * @throws IOException
     */
    public IpVo btreeSearch(String ip) throws IOException {
